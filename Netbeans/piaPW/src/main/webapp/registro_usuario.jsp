...
<input type="password" name="Contrasena" placeholder="Contraseña" class="input-cont" required>
<input type="password" name="Conf-Contraseña" placeholder="Confirmar Contraseña" class="input-cont" required>
